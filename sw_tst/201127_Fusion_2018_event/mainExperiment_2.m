function mainExperiment_2( dataset, options )
if nargin<1
    dataset = 'ev_kinova_3_mixed';
end
if nargin<2
    options= [];
end
...
[orb_slam, trajs, i] = mainExperiment_loop(orb_slam, IMU_img_struct, state_camera_struct, NbStepsMax, obsTimes, ParamFilter, ParamGlobal);

%% Plots
%replace with relevant fucntions
helperSaveData(trajs, dataset, ParamGlobal);
